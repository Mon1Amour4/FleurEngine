...
std::shared_ptr<Fleur::Graphics::Texture> Fleur::Graphics::DeviceOpenGL::CreateTexture(std::string_view name, ETextureFormat format, unsigned char* buffer,
                                                                                       uint32_t width, uint32_t height) const
{
    return std::make_shared<Fleur::Graphics::TextureOpenGL>(name, buffer, format, width, height, static_cast<uint16_t>(1));
}

std::shared_ptr<Fleur::Graphics::Texture> Fleur::Graphics::DeviceOpenGL::CreateTexture(std::string_view name) const
{
    return std::make_shared<Fleur::Graphics::TextureOpenGL>(name, static_cast<uint16_t>(1));
}
