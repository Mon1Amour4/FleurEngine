...
// }
//
// Fleur::Graphics::TextureOpenGL::TextureOpenGL(std::string_view name, std::string_view ext, const unsigned char* buffer, ETextureFormat format, uint32_t
// width,
...
//         //FL_CORE_ASSERT(img && img->GetData(), "Cubemap image is null or has no data");
//
...
//                             GL_UNSIGNED_BYTE,
//                             reinterpret_cast<const void*>(img->GetData())  // pointer to data
//         );
//     }
//
//
