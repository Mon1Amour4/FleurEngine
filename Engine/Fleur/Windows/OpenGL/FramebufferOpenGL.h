...
protected:
    ...
    virtual void AddDepthAttachment(std::shared_ptr<Fleur::Graphics::Texture> attachment, bool combined = true) override;
    virtual void AddStencilAttachment(std::shared_ptr<Fleur::Graphics::Texture> attachment) override;
