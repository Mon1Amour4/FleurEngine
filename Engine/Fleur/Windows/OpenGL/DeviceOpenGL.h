...
public:
    ...
    virtual std::unique_ptr<Buffer> CreateBuffer(Buffer::EBufferType type, ERenderStage stage, size_t size) override;
    ...
    virtual std::shared_ptr<Texture> CreateCubemap(const Image2D* cubemapImage) const override;
